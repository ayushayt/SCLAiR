...
def create_encoder():
    ...
    outputs = layers.LSTM(256,activation='tanh')(inputs)
...
df.to_csv('results/final_results/Accuracies_lstm_sup_con.csv',index=False)
np.save('results/final_results/pred_arr_lstm_sup_con.npy',pred_arr)
np.save('results/final_results/test_arr_lstm_sup_con.npy',test_arr)

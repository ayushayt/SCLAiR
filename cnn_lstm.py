...
from tensorflow.keras.layers import Dense, Activation, Conv1D, MaxPooling1D, GlobalAveragePooling1D, Flatten, Dropout, BatchNormalization, Input,LSTM
...
df.to_csv('results/final_results/Accuracies_1dcnn_lstm.csv',index=False)
np.save('results/final_results/pred_arr_1dcnn_lstm.npy',pred_arr)
np.save('results/final_results/test_arr_1dcnn_lstm.npy',test_arr)

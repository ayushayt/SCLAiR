...
def create_encoder():
    ...
    outputs = layers.Bidirectional(layers.LSTM(256,activation='tanh'))(inputs)
...
df.to_csv('results/final_results/Accuracies_bilstm_sup_con.csv',index=False)
np.save('results/final_results/pred_arr_bilstm_sup_con.npy',pred_arr)
np.save('results/final_results/test_arr_bilstm_sup_con.npy',test_arr)
